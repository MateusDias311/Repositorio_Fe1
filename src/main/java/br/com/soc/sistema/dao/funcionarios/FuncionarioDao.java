...
public class FuncionarioDao extends Dao {
	...
	public boolean deleteFuncionario(int cod) {
        ...
        try (Connection con = getConexao();
            ...
            e.printStackTrace();
            throw new RuntimeException("Erro ao executar a exclusão do funcionario.", e);
        }
    }
		
	public boolean excluindoFuncionario(String rowid) {
